            ...
            <div className={'mt-4 text-lg leading-6'}>
              ...
              <div className={'text-sm leading-6 mt-4'}>
                ...
                <ul className={'list-disc pl-5 mt-4'}>
                  ...
                  <li>Papayas use and transfer to any other app of information received from Google APIs will adhere to Google API Services User Data Policy, including the Limited Use requirements.</li>
                </ul>
              </div>
            </div>
          </div>
