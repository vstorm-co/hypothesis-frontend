					...
					<div className="mx-auto 2xl:max-w-[1280px] max-w-[860px] w-full">
						<div className="h-[100vh] flex flex-col pt-4 pb-2 relative">
							...
							<div className={'relative'}>
								...
								<div onClick={() => { dispatch(hSliceActions.toggleShowLogs(!showAnnotateLogs)) }} className={'absolute text-sm flex bottom-[7.9rem] left-[8.5rem] cursor-pointer text-[#595959] '}>
