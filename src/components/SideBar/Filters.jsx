...
export function Filters() {
  ...
  return (
    <div ref={filtersRef} className={'relative'}>
      <div className={' text-[#747474] hover:text-[#DBDBDB] cursor-pointer rounded p-2 ' + (showFilters.value ? ' text-[#DBDBDB]' : '')} onClick={toggleShowFilters}>
      ...
      <div className={"absolute z-50 w-96 border rounded max-w-[280px] md:max-w-[320px] top-12  md:top-0 -left-64 md:left-12 bg-[#202020] " + (showFilters.value ? '' : 'hidden')}>
