...
export function Filters() {
  ...
  return (
    <div ref={filtersRef} className={'relative'}>
      <div className={'hover:bg-[#595959] cursor-pointer p-2 ' + (showFilters.value ? 'bg-[#595959]' : '')} onClick={toggleShowFilters}>
        <img src={filtersIcon} alt="" />
      </div>
      <div className={"absolute z-50 w-80 border rounded top-0 left-12 bg-[#202020] " + (showFilters.value ? '' : 'hidden')}>
        <div className="border-b pt-4 px-4 pb-2">
          <div className="text-xs font-bold mb-1">
            Visibility
          </div>
          <div className={'text-sm leading-6 flex text-[#747474]'}>
            <div className={'cursor-pointer pr-2 py-1 rounded hover:bg-[#747474] hover:text-white'}>All</div>
            <div className={'cursor-pointer px-2 py-1 rounded hover:bg-[#747474] hover:text-white'}>Just Me</div>
