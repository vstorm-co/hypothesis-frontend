    ...
    <div ref={optionsRef} className="ml-2 relative">
      ...
      <div className={"absolute border border-[#595959] rounded w-[240px] bottom-0 left-12 bg-[#0F0F0F] " + (showOptions.value ? '' : 'hidden')}>
        <div className="text-sm leading-6">
          <Link onClick={() => showOptions.value = false} href="/organization-settings" className={"cursor-pointer border-b border-[#595959] flex items-center w-full py-3 px-4 hover:bg-[#595959]"}>
            <span>
