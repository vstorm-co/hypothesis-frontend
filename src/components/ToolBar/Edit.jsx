...
export function Edit(props) {
  ...
  return (
    <div className="relative">
      ...
      <div className={"absolute border rounded -right-[7rem] top-10 bg-white " + (props.show ? '' : 'hidden')}>
        ...
        <div className={'p-2'}>
          <div onClick={toggleConfirmDelete} className={'flex p-2 hover:bg-[#F2F2F2] rounded cursor-pointer'}>
            <img src={bin} alt="" />
            <div className={'ml-2'}>
              Delete chat
            </div>
          </div>
          <div className={'absolute -right-[2.5rem] rounded -bottom-[5.8rem] flex flex-col bg-[#020202] text-white w-[350px] ' + (confirmDelete.value ? '' : 'hidden')}>
